...
MINIMUM_PERCENT_PRICE_CHANGE = float(os.environ.get("MINIMUM_PERCENT_PRICE_CHANGE"))
...
PERCENT_DEVIATION_TRAILING_STOP_LOSS_THRESHOLD = float(os.environ.get("PERCENT_DEVIATION_TRAILING_STOP_LOSS_THRESHOLD"))
